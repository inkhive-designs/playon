...
<article id="post-<?php the_ID(); ?>" <?php post_class('col-md-6 col-sm-6 col-xs-12 grid inkshades'); ?>>
        <div class="featured-thumb hvr-shadow-radial">
            <?php if (has_post_thumbnail()) : ?>
                <a href="<?php the_permalink() ?>" title="<?php the_title() ?>"><?php the_post_thumbnail('inkshades-thumb',array(  'alt' => trim(strip_tags( $post->post_title )))); ?></a>
            <?php else: ?>
