 ...
 */
?>
<article id="post-<?php the_ID(); ?>" <?php post_class('col-md-4 col-sm-4 col-xs-12 grid playon'); ?>>
        <div class="featured-thumb">
            ...
            <div class="img-meta-with-video">
                        <div class="left">
                            ...
                            ?>
                            <div class="img-meta-img meta-icon"><a class='meta-link meta-link-img' title="<?php the_title(); ?>" href="<?php echo $thumb_url[0] ?>" data-lity><i class="fa fa-image fa-play-image"></i></a></div>
                        </div>
                        <div class="right">
