...
<div id="featured-area-2">
    <div class="container">
            <?php if (get_theme_mod('playon_fa2_title')) : ?>

            <div class="section-title">
                <span><?php echo get_theme_mod('playon_fa2_title',__('Popular Articles','playon')); ?></span>
            </div>
            <?php endif; ?>
            ...
            $args = array(
                    'posts_per_page' => 3,
                    'category' => get_theme_mod('playon_fa2_cat') );
