        ...
        <div class="featured-cat-container container">
            <?php if(get_theme_mod('playon_featcat_title') != '' ): ?>
                <div class="section-title">
                        <span>
                            <?php echo esc_html(get_theme_mod('playon_featcat_title', __('Featured Category Area','playon'))); ?>
                        </span>
                </div>
            <?php endif; ?>
        <div class="cat">
            <?php for( $i=1; $i<=6; $i++ ) : ?>
                <div class="f-cat-wrapper col-md-4 col-sm-4">
                    ...
                    if ($catname != '' ) :
                        ...
                        $catid = get_theme_mod('playon_featposts_category_'.$i);
                        ...
                        if($the_query->have_posts()) :
                            while ($the_query -> have_posts()) :
                                ...
                                <div class="out-thumb">
                                    ...
                                    <?php if ( $catdesc != '' ) : ?>
                                        <div class="cat-desc">
                                            <p><?php  print_r( substr($catdesc, 0, 100) . (strlen($catdesc) >= 100 ? "..." : "") ); ?></p>
                                        </div>
                                    <?php endif; ?>
                                </div>
                            <?php endwhile;
